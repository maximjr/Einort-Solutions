...
// Updates for mobile-app-development
const enMobileFaqs = [
  {
...
// Updates for seo-google-workspace
const enSeoFaqs = [
  {
...
// Updates for digital-advertising
const enAdsFaqs = [
  {
...
enData['websites-web-apps'].faqs = enWebFaqs;
frData['websites-web-apps'].faqs = frWebFaqs;

enData['erp-solutions'].faqs = enErpFaqs;
frData['erp-solutions'].faqs = frErpFaqs;

enData['mobile-app-development'].faqs = enMobileFaqs;
frData['mobile-app-development'].faqs = frMobileFaqs;

enData['ui-ux-design'].faqs = enUiFaqs;
frData['ui-ux-design'].faqs = frUiFaqs;

enData['seo-google-workspace'].faqs = enSeoFaqs;
frData['seo-google-workspace'].faqs = frSeoFaqs;

enData['digital-advertising'].faqs = enAdsFaqs;
frData['digital-advertising'].faqs = frAdsFaqs;
