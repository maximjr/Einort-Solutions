...
export function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white flex overflow-hidden font-sans selection:bg-electric-blue selection:text-white relative">
      <SEO title="EINORT || NEXUS ADMIN" />
      
      {/* Ambient background for the entire admin */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-electric-blue/5 rounded-full blur-[150px] pointer-events-none" />
      ...
      >
        <div className="absolute top-0 right-0 w-[1px] h-full bg-gradient-to-b from-transparent via-electric-blue/20 to-transparent" />
        
        {/* Header */}
        <div className="h-20 flex items-center px-6 border-b border-white/5">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 geometric-clip border border-electric-blue/30 bg-electric-blue/10 flex items-center justify-center">
            ...
            <div>
              ...
              <span className="font-mono text-[9px] text-electric-blue tracking-widest uppercase opacity-80">Command Center</span>
            </div>
          </div>
        </div>
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-lg geometric-clip font-mono text-xs tracking-widest uppercase transition-all duration-300 relative group overflow-hidden ${
                  isActive 
                    ? 'text-white border border-electric-blue/30 bg-electric-blue/10 shadow-[0_0_15px_rgba(59,130,246,0.1)]' 
                    : 'text-silver-metallic hover:text-white hover:bg-white/5 border border-transparent'
                }`}
              >
                {isActive && (
                  <motion.div layoutId="sidebar-active" className="absolute left-0 top-1/4 bottom-1/4 w-[2px] bg-electric-blue" />
                )}
                <div className="absolute inset-0 bg-gradient-to-r from-electric-blue/0 via-electric-blue/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700" />
                <Icon className={`w-4 h-4 relative z-10 ${isActive ? 'text-electric-blue' : 'text-silver-metallic/70 group-hover:text-white'}`} />
        ...
        <div className="p-4 border-t border-white/5">
          <div className="glass-panel geometric-clip border-white/5 p-4 flex items-center justify-between group hover:border-electric-blue/30 transition-colors">
            <div className="flex items-center gap-3 overflow-hidden">
               ...
               <div className="flex flex-col truncate">
                 ...
                 <span className="font-mono text-[9px] text-electric-blue truncate tracking-widest uppercase mt-0.5">Level 9 Auth</span>
               </div>
            </div>
