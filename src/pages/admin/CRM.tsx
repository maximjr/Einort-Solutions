              ...
              <div className="p-6 border-b border-white/5 flex items-start justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-1">
                    <h2 className="text-2xl font-display font-medium text-white">{selectedLead.company || selectedLead.name}</h2>
                    {selectedLead.health && (
                  ...
                  <div className="flex items-center gap-2 text-sm text-white/50">
                     ...
                     {selectedLead.name !== selectedLead.company ? selectedLead.name : selectedLead.contact} ({selectedLead.email})
                  </div>
                </div>
