...
export function About() {
  ...
  return (
    <section id="about" ref={containerRef} className="py-32 lg:py-48 relative bg-dark overflow-hidden border-t border-white/5">
      ...
      <motion.div style={{ y, opacity }} className="absolute left-[-10%] top-1/4 w-[600px] h-[600px] bg-electric-blue/10 rounded-full blur-[150px] pointer-events-none mix-blend-screen" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <motion.div 
              ...
              className="space-y-6 text-lg md:text-xl text-silver-metallic font-light leading-relaxed border-l-2 border-electric-blue/30 pl-6"
            >
              <p>
            ...
            >
              <div className="relative group cursor-default">
                <div className="absolute -left-4 top-0 w-[2px] h-full bg-gradient-to-b from-electric-blue to-transparent group-hover:h-full group-hover:bg-electric-blue transition-all duration-500" />
                <p className="font-display text-5xl font-bold text-white mb-3 group-hover:text-glow-silver transition-colors">10<span className="text-electric-blue">+</span></p>
                <p className="text-[10px] font-mono uppercase tracking-[0.2em] text-silver-metallic font-bold group-hover:text-electric-blue transition-colors">Years of Mastery</p>
              </div>
              <div className="relative group cursor-default">
                <div className="absolute -left-4 top-0 w-[2px] h-full bg-gradient-to-b from-neon-blue to-transparent group-hover:h-full group-hover:bg-neon-blue transition-all duration-500" />
                <p className="font-display text-5xl font-bold text-white mb-3 group-hover:text-glow-silver transition-colors">250<span className="text-neon-blue">+</span></p>
                <p className="text-[10px] font-mono uppercase tracking-[0.2em] text-silver-metallic font-bold group-hover:text-neon-blue transition-colors">Enterprise Deployments</p>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-electric-blue/30 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-1000 z-15 mix-blend-screen pointer-events-none" />
            ...
            <div className="absolute inset-x-6 lg:inset-x-8 bottom-6 lg:bottom-10 z-20">
               <div className="p-8 lg:p-10 holographic-panel geometric-clip-right border border-white/10 backdrop-blur-2xl relative overflow-hidden group-hover:border-electric-blue/50 transition-colors duration-700">
                 <div className="absolute top-0 right-0 w-32 h-32 bg-electric-blue/20 blur-[50px] pointer-events-none" />
                 ...
                 <div className="flex items-center gap-3 mb-6 relative z-10">
                   <div className="w-2 h-2 geometric-diamond bg-neon-blue animate-pulse shadow-[0_0_10px_#3b82f6]" />
