      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 pb-32">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
             ...
             >
               <div className="w-8 h-8 geometric-diamond bg-white/5 flex items-center justify-center border border-white/10">
                 <div className="w-2 h-2 bg-oxblood geometric-diamond animate-pulse shadow-[0_0_10px_#3b82f6]" />
               </div>
             ...
             <motion.p
               ...
               className="text-silver-metallic text-lg md:text-xl font-light mb-12 max-w-md leading-relaxed border-l-2 border-premium-gold/30 pl-6"
             >
             ...
             >
               <div className="flex items-center gap-6 group">
                 <div className="w-14 h-14 geometric-clip-right bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-premium-gold/50 transition-colors duration-500 shadow-sm relative overflow-hidden">
                   ...
                   <Mail className="w-5 h-5 text-premium-gold relative z-10" />
                 </div>
                 <div>
               ...
               <div className="flex items-center gap-6 group">
                 <div className="w-14 h-14 geometric-clip-right bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-oxblood/50 transition-colors duration-500 shadow-sm relative overflow-hidden">
                   <div className="absolute inset-0 bg-gradient-to-br from-oxblood/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                   <MapPin className="w-5 h-5 text-oxblood relative z-10" />
                 </div>
                 <div>
          ...
          <motion.div
             ...
             className="holographic-panel p-8 md:p-12 geometric-clip border border-white/10 relative overflow-hidden group hover:border-premium-gold/30 transition-colors duration-700"
          >
             <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-premium-gold/10 blur-[100px] rounded-full pointer-events-none group-hover:bg-premium-gold/20 transition-colors duration-700" />
             <div className="absolute bottom-0 left-0 w-24 h-24 bg-oxblood/10 blur-[50px] rounded-full pointer-events-none" />
             ...
             <form className="relative z-10 flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
               <div className="grid md:grid-cols-2 gap-6">
                 <div className="flex flex-col gap-2">
                   ...
                   <input id="firstName" type="text" className="bg-dark/50 geometric-clip-right border border-white/10 px-5 py-4 text-white focus:outline-none focus:border-premium-gold transition-colors placeholder:text-white/20 font-light" placeholder="John" />
                 </div>
                 <div className="flex flex-col gap-2">
                   ...
                   <input id="lastName" type="text" className="bg-dark/50 geometric-clip-right border border-white/10 px-5 py-4 text-white focus:outline-none focus:border-premium-gold transition-colors placeholder:text-white/20 font-light" placeholder="Doe" />
                 </div>
               </div>
               ...
               <div className="flex flex-col gap-2">
                 ...
                 <input id="email" type="email" className="bg-dark/50 geometric-clip-right border border-white/10 px-5 py-4 text-white focus:outline-none focus:border-premium-gold transition-colors placeholder:text-white/20 font-light" placeholder="john@enterprise.com" />
               </div>
               ...
               <div className="flex flex-col gap-2">
                 ...
                 <textarea id="message" rows={4} className="bg-dark/50 geometric-clip-right border border-white/10 px-5 py-4 text-white focus:outline-none focus:border-premium-gold transition-colors placeholder:text-white/20 font-light resize-none" placeholder="Outline your architectural vision..." />
               </div>
               ...
               <button className="group/btn relative w-full flex items-center justify-center gap-4 bg-white text-dark px-8 py-5 geometric-clip font-bold uppercase tracking-[0.2em] font-mono text-sm overflow-hidden mt-6 hover:shadow-[0_0_30px_rgba(37,99,235,0.4)] transition-all">
                 ...
                 <div className="absolute inset-0 bg-premium-gold transform scale-x-0 origin-left transition-transform duration-700 ease-[0.16,1,0.3,1] group-hover/btn:scale-x-100" />
               </button>
             </form>
          </motion.div>
