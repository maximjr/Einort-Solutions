...
const steps = [
  ...
  { id: '07', title: 'System Scaling', desc: 'Continuous optimization and AI-driven performance scaling.' }
];
    ...
    <section id="process" className="py-32 lg:py-48 relative bg-dark border-t border-white/5 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="text-center mb-32 max-w-3xl mx-auto">
          ...
          >
             <div className="flex items-center gap-3">
               <div className="w-8 h-8 geometric-clip bg-white/5 flex items-center justify-center border border-white/10">
                 <div className="w-1.5 h-1.5 bg-electric-blue animate-pulse" />
               </div>
               <span className="text-xs font-mono font-bold uppercase tracking-[0.3em] text-silver-metallic">Evolution Framework</span>
             </div>
          </motion.div>
          <motion.h2 
          ...
          >
            The Physics of <br />
            <span className="text-gradient-metallic italic font-light font-display">Digital Creation.</span>
          </motion.h2>
          <motion.p
            ...
            className="text-silver-metallic text-lg md:text-xl font-light max-w-2xl mx-auto"
          >
        ...
        <div className="relative">
          ...
          <div className="absolute left-[28px] md:left-1/2 top-0 bottom-0 w-[2px] bg-white/5 md:-translate-x-1/2">
             <div className="absolute top-0 w-full h-[30%] bg-gradient-to-b from-electric-blue via-neon-blue/50 to-transparent animate-pulse" />
          </div>
              ...
              return (
                ...
                >
                  <div className={`flex-1 w-full md:w-1/2 ${isEven ? 'md:text-left' : 'md:text-right'} pl-20 md:pl-0`}>
                    <div className="glass-panel p-8 md:p-10 geometric-clip border border-white/5 hover:border-electric-blue/50 transition-colors duration-500 relative group overflow-hidden bg-gradient-to-br from-white/[0.02] to-transparent">
                      ...
                      <h3 className="font-display text-2xl md:text-3xl font-medium mb-4 relative z-10 text-white tracking-tight group-hover:text-glow-silver transition-colors duration-500">{step.title}</h3>
                      <p className="text-silver-metallic font-light leading-relaxed relative z-10">{step.desc}</p>
                    </div>
                  </div>
                  
                  {/* Central Node */}
                  <div className="absolute left-[12px] md:left-1/2 -translate-x-1/2 flex items-center justify-center w-10 md:w-16 h-10 md:h-16 geometric-clip bg-dark border border-white/20 z-10 group transition-all duration-500 hover:border-electric-blue hover:shadow-[0_0_30px_rgba(59,130,246,0.3)] shadow-[0_0_15px_rgba(0,0,0,0.5)]">
